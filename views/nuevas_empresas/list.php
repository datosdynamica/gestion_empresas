        ...
        <div class="flex flex-wrap gap-3 w-full lg:w-auto">
            ...
            <div class="flex items-center gap-2 bg-slate-50 border border-slate-200 px-3 py-1.5 rounded-lg text-sm w-full sm:w-auto">
                ...
                <select id="filtro-hito" class="bg-transparent border-none focus:outline-none text-slate-700 font-semibold cursor-pointer">
                    ...
                    <option value="Envío de Factura">7. Envío de Factura</option>
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                <div class="lg:col-span-2 space-y-4">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 bg-white p-4 rounded-xl border border-slate-200">
                                        ...
                                        <div class="flex items-start gap-3 p-2 opacity-50"><span class="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-slate-150 text-slate-400"><i data-lucide="circle" class="w-3.5 h-3.5"></i></span><div><h5 class="text-xs font-bold text-slate-500">7. Envío de Factura <span class="text-[9px] bg-slate-100 text-slate-500 px-1 py-0.2 rounded font-normal">Auto</span></h5><p class="text-[10px] text-slate-400">Primera factura de servicio</p></div></div>
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                <div class="lg:col-span-2 space-y-4">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 bg-white p-4 rounded-xl border border-slate-200">
                                        ...
                                        <div class="flex items-start gap-3 p-2 opacity-50"><span class="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-slate-150 text-slate-400"><i data-lucide="circle" class="w-3.5 h-3.5"></i></span><div><h5 class="text-xs font-bold text-slate-500">7. Envío de Factura <span class="text-[9px] bg-slate-100 text-slate-500 px-1 py-0.2 rounded font-normal">Auto</span></h5><p class="text-[10px] text-slate-400">Facturación inicial</p></div></div>
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                <div class="lg:col-span-2 space-y-4">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 bg-white p-4 rounded-xl border border-slate-200">
                                        ...
                                        <div class="flex items-start gap-3 p-2 rounded-lg bg-slate-50"><span class="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-emerald-100 text-emerald-600"><i data-lucide="check" class="w-3.5 h-3.5"></i></span><div><h5 class="text-xs font-bold text-slate-700">7. Envío de Factura <span class="text-[9px] bg-indigo-100 text-indigo-700 px-1 py-0.2 rounded font-normal">Auto</span></h5><p class="text-[10px] text-slate-400">Primera factura emitida</p></div></div>
